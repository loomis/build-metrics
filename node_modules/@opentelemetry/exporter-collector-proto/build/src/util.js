...
function send(collector, objects, onSuccess, onError) {
    ...
    if (message) {
        ...
        if (body) {
            exporter_collector_1.sendWithHttp(collector, Buffer.from(body), 'application/x-protobuf', onSuccess, onError);
        }
    }
    else {
        onError(new exporter_collector_1.collectorTypes.CollectorExporterError('No proto'));
    }
}
exports.send = send;
